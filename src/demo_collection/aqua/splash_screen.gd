...
export(String, FILE) var logo_path = "res://assets/Captain Clown Nose/Captain Clown Nose/Captain Clown Nose without Sword/01-Idle/Idle 01.png"
export(String) var title := "Pirate Island"
export(String) var description := "Kumpulkan semua harta"
